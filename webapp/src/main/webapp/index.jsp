<form action="action_page.php">
  <div class="container">
    ...
    <p>Please fill in this form to create an personal account.</p>
    <hr>
    ...
    <input type="password" placeholder="Enter your personal Password" name="psw" id="psw" required>
    <br>
    ...
    <hr>
    <br>
    <p>By creating an Gmail account you agree to our <a href="#">Terms & Privacy</a>.</p>
